...
mkdir -p /usr/src/ott/openvpn/EU-Regular-1
mkdir -p /usr/src/ott/openvpn/EU-Regular-2
mkdir -p /usr/src/ott/openvpn/EU-Regular-3
mkdir -p /usr/src/ott/openvpn/US-West-Regular-1
mkdir -p /usr/src/ott/openvpn/AU-Regular-1
mkdir -p /usr/src/ott/openvpn/US-East-Regular-1
mkdir -p /usr/src/ott/openvpn/IN-Regular-1
mkdir -p /usr/src/ott/openvpn/EU-VIP-1
mkdir -p /usr/src/ott/openvpn/US-West-VIP-1
mkdir -p /usr/src/ott/openvpn/EU-VIP-2
mkdir -p /usr/src/ott/openvpn/EU-Networks-1

# other folders that need to be created
mkdir -p /usr/src/ott/views/uploaded/avatars/
mkdir -p /usr/src/ott/views/uploaded/badges/
mkdir -p /usr/src/ott/views/uploaded/certificates/
mkdir -p /usr/src/ott/views/uploaded/room-badges/
mkdir -p /usr/src/ott/views/uploaded/user_avatars/

# start the server
if [ "$THM_NODE_PROD_TYPE" = "prod" ]; then
	echo "Starting web service using pm2 ... "
	cd /usr/src/ott && pm2 start index.js -i max && pm2 logs
else
