 ...
 *
 * This class extends the built-in Error class to provide custom properties and handling for errors related to pre-signed URLs.
 */
export class PreSignedUrlException extends Error {
  /**
   * Error code associated with the exception.
   *
   * This property allows developers to categorize different types of pre-signed URL errors.
  ...
  /**
   * Creates a new PreSignedUrlException instance.
   *
   * @param message - The error message describing the exception in detail.
   * @param code - Optional. The error code associated with the exception (default: 'PRE_SIGNED_URL_ERROR').
   ...
   *
   * This constructor initializes the PreSignedUrlException with an error message, an error code, and optionally a stack trace.
  ...
  constructor(message: string, code: string = 'PRE_SIGNED_URL_ERROR', stackTrace?: string) {
     ...
     * If no code is provided, defaults to 'PRE_SIGNED_URL_ERROR'.
     * This allows developers to categorize different types of pre-signed URL errors.
     */
    this.code = code;
